#!/usr/bin/env python3
"""Check the isolated four-anchor r8 reference and its installation scenarios.
...
SOURCES = (
    "enclosure/fusion-r8/reference/carrier-case.scad",
    "enclosure/carrier-case.scad",
    "enclosure/fusion-r8/reference/carrier-interface.scad",
...
def main() -> int:
    ...
    report = {
        "status": "RUNNING", "revision": "carrier-enclosure-fusion-r8-reference",
