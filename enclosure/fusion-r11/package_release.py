"""Validate and package the reinforced r11 fit prototype; never edit hardware."""
...
def main():
    ...
    manifest = {
        'revision': 'r11 bottom mounting inserts',
    ...
    archive = OUT / 'pitclaw-enclosure-r11.zip'
