"""Export the four printed r11 parts and illustrate the assembly sequence."""
...
def run(_context):
    ...
    if d.snapshots.hasPendingSnapshot:d.snapshots.add().name='Restore assembled r11 positions'
    ...
    camera(app,(9,-20,5))
    runpy.run_path(str(OUT/'check_native_r11.py'))['run'](_context)
    target=OUT/'pitclaw-enclosure-r11.f3d'
