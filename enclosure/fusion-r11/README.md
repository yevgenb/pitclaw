# Enclosure with hidden mounting inserts — Fusion r11

R11 adds **four M3 mounting inserts inside the bottom shell**, on a
...
- [Complete Fusion model and print package](pitclaw-enclosure-r11.zip).
- [Editable Fusion model](pitclaw-enclosure-r11.f3d).
...
The independent reference passes 26 modeled geometry scenarios: carrier and
...
interior heat-setting tool access. Ten reference meshes
