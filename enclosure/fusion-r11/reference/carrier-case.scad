...
if(part=="mount-coupon") translate([-35,-37.5,0]) mount_coupon();
    ...
    difference() {
        union() {
            ...
            for(s=[-1,1]) scale([s,1,1]) {
                box_bounds(31,33,-52,-42.5,2.48,8);
                box_bounds(32.7,36,-52,-43,3.8,5.8);
                box_bounds(32.7,36,-52,-50.7,5.8,7.8);
...
module bottom_shell_r10() {
    difference() {
        ...
        for(s=[-1,1]) scale([s,1,1])
            box_bounds(32.7,36.3,-52.1,-43,3.8,8.1);
    }
}
...
module fascia_lift_collision() {
    ...
    // At exactly0.3mm, seamZ27.6 and front-runnerZ8.1 both intentionally contact.
...
// r11 interior future-mount inserts, accessible from the outside bottom.
