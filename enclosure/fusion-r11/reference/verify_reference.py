#!/usr/bin/env python3
"""Check the isolated r11 interior-mount-insert handedness reference and its installation scenarios.

Run with Python 3 plus trimesh, for example:
  python3 enclosure/fusion-r11/reference/verify_reference.py
...
def main() -> int:
    ...
    report = {
        "status": "RUNNING", "revision": "carrier-enclosure-fusion-r11-reference",
