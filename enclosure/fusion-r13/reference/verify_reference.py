#!/usr/bin/env python3
"""Verify the accepted r13 enclosure and its six assembly/calibration coupons.

Run with Python 3 plus trimesh, for example:
  python3 enclosure/fusion-r13/reference/verify_reference.py
...
MESH_NAMES = {
    ...
    "joint_fascia":"joint-coupon-fascia.stl","coupon":"fit-coupon.stl",
    "insert_coupon":"insert-coupon.stl","mount_coupon":"mount-coupon.stl",
}
...
def main() -> int:
    ...
    report = {
        "status": "RUNNING", "revision": "carrier-enclosure-fusion-r13-reference",
    ...
    report["status"] = "PASS: CAD GEOMETRY" if passed else "FAIL"
