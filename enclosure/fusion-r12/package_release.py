"""Validate and package the reinforced r12 fit prototype; never edit hardware."""
...
SIZES = {
    ...
    'carrier-retainer': [80, 96, 2.5], 'probe-fascia': [72, 27.3, 9.5],
    'joint-coupon-bottom': [33, 11.5, 27.6], 'joint-coupon-top': [33, 11.5, 21.9],
    'joint-coupon-fascia': [26, 27.3, 9.5],
...
def main():
    ...
    assert reference['status'] == 'PASS: FIT PROTOTYPE'
    ...
    files = [OUT / p for p in [
        ...
        'guide-review.md', 'guide-section-comparison.png', 'guide-section-comparison.svg',
        'pitclaw-enclosure-r12.f3d',
        'native-verification.json', 'mesh-verification.json', 'build-native.json',
        'reference/fit-verification.json',
        'reference/guide-section-verification.json',
    ...
    manifest = {
        'revision': 'r12 continuous fascia guides',
        ...
        'guide_engagement_mm': 9, 'guide_side_clearance_mm': .4,
        'guide_roof_normal_clearance_mm': .5 / (2 ** .5),
    ...
    archive = OUT / 'pitclaw-enclosure-r12.zip'
