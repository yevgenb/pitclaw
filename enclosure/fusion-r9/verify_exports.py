"""Validate native Fusion STL exports against the independent r8 reference.
...
def main():
    ...
    for part in ('bottom','top','retainer'):
        path=OUT/'native-stl'/f'carrier-{part}.stl'
        ...
        ref_path=OUT/'reference'/f'carrier-{part}.stl'
        ...
        target=OUT/'stl'/f'carrier-{part}.stl'
