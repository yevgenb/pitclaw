// PitClaw Rev B carrier enclosure r9: two outer halves + internal retainer.
...
module carrier_sweep_board_coordinates(offset0,offset1,lift0,lift1) {
    ...
    for(x=carrier_probe_x)
        swept_carrier_box([x-33,carrier_probe_face_y-46,
                          checked_top+probe_axis_above_pcb-probe_body_height/2],
                         [6,12,probe_body_height],offset0,offset1,lift0,lift1);
