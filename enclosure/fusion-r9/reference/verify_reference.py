#!/usr/bin/env python3
"""Check the isolated four-anchor r9 handedness reference and its installation scenarios.

Run with Python 3 plus trimesh, for example:
  python3 enclosure/fusion-r9/reference/verify_reference.py
...
SOURCES = (
    "enclosure/fusion-r9/reference/carrier-case.scad",
    "enclosure/carrier-case.scad",
    "enclosure/fusion-r9/reference/carrier-interface.scad",
...
def main() -> int:
    ...
    report = {
        "status": "RUNNING", "revision": "carrier-enclosure-fusion-r9-reference",
