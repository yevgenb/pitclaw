"""Validate and package the reinforced r10 fit prototype; never edit hardware."""
...
def main():
    ...
    for name in ['fit-coupon', 'insert-coupon']:
        assert meshes[name]['sha256'] == sha(ROOT / 'enclosure/fusion-r9/stl' / (name + '.stl'))

    files = [OUT / p for p in [
        'README.md', 'bezel-key-assessment.md', 'pitclaw-enclosure-r10.f3d',
    ...
    manifest = {
        'revision': 'r10 reinforced probe insert',
    ...
    archive = OUT / 'pitclaw-enclosure-r10.zip'
