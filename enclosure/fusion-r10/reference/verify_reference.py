#!/usr/bin/env python3
"""Check the isolated r10 removable-probe-panel handedness reference and its installation scenarios.

Run with Python 3 plus trimesh, for example:
  python3 enclosure/fusion-r10/reference/verify_reference.py
...
SOURCES = (
    "enclosure/fusion-r10/reference/carrier-case.scad",
    "enclosure/carrier-case.scad",
    "enclosure/fusion-r10/reference/carrier-interface.scad",
...
def scenarios() -> list[Check]:
    checks = [Check("nominal-" + part, part, (1.6, 1.6, 3, 0, 0)) for part in (
        ...
        "shell-closure-check", "fascia-fit-check", "fascia-insertion-check", "lid-closing-check", "fascia-lift-check")]
...
def main() -> int:
    ...
    report = {
        "status": "RUNNING", "revision": "carrier-enclosure-fusion-r10-reference",
        ...
        "assumptions": [
            ...
            "Only shell closure may retain triangles strictly coplanar at Z=27.6 mm; other intersections must be empty.",
