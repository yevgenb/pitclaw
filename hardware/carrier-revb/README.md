...
the enclosure checks its local clearance separately without increasing case depth. See the [revised case stack](../../enclosure/fusion-r13/README.md).
...
- [Current enclosure fit prototype](../../enclosure/fusion-r13/README.md): bottom
